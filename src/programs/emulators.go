...
func Cemu() *Program {
	return &Program{
		...
		RequiredFolders: []string{"$EMULATORS", "$STATE/Cemu", "$ROMS/WIIU", "$BIOS/WIIU"},
		...
		Package: packaging.Best(&linux.Flatpak{
			...
			AppURL:  "https://api.github.com/repos/cemu-project/Cemu/releases",
		}, &macos.Application{
			AppID:   "cemu.portable",
...
func Citra() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Citra", "$ROMS/3DS", "$BIOS/3DS"},
...
func Citron() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Citron", "$ROMS/SWITCH", "$BIOS/SWITCH"},
...
func Dolphin() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Dolphin", "$ROMS/GC", "$BIOS/GC", "$ROMS/WII", "$BIOS/WII"},
...
func DuckStation() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/DuckStation", "$ROMS/PS1", "$BIOS/PS1"},
...
func Flycast() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Flycast", "$ROMS/DC", "$BIOS/DC"},
...
func Lime3DS() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Lime3DS", "$ROMS/3DS", "$BIOS/3DS"},
...
func MelonDS() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/MelonDS", "$ROMS/NDS", "$BIOS/NDS"},
...
func MGBA() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/MGBA", "$ROMS/GBA", "$BIOS/GBA"},
...
func PCSX2() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/PCSX2", "$ROMS/PS2", "$BIOS/PS2"},
...
func PPSSPP() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/PPSSPP", "$ROMS/PSP", "$BIOS/PSP"},
...
func Redream() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Redream", "$ROMS/DC", "$BIOS/DC"},
...
func RPCS3() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/RPCS3", "$ROMS/PS3", "$BIOS/PS3"},
...
func Ryujinx() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Ryujinx", "$ROMS/SWITCH", "$BIOS/SWITCH"},
...
func ShadPS4() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/ShadPS4", "$ROMS/PS4", "$BIOS/PS4"},
...
func Simple64() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Simple64", "$ROMS/N64", "$BIOS/N64"},
...
func Vita3K() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Vita3K", "$ROMS/PSVITA", "$BIOS/PSVITA"},
...
func Xemu() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Xemu", "$ROMS/XBOX", "$BIOS/XBOX"},
...
func Xenia() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Xenia", "$ROMS/X360", "$BIOS/X360"},
		...
		Package: packaging.Best(&windows.Executable{
...
func Yuzu() *Program {
	return &Program{
		...
		Category:        "Emulators",
		Tags:            []string{"Gaming", "Emulator"},
		RequiredFolders: []string{"$EMULATORS", "$STATE/Yuzu", "$ROMS/SWITCH", "$BIOS/SWITCH"},
