...
func Yuzu() *Program {
	return &Program{
		...
		Category:    "Emulators",
		Tags:        []string{"Gaming", "Emulator"},
		Folders:     []string{"$EMULATORS", "$STATE/Yuzu", "$ROMS/SWITCH", "$BIOS/SWITCH"},
		Website:     "https://yuzu-mirror.github.io",
		IconURL:     "https://cdn2.steamgriddb.com/icon/bdae89f883fd9206bc02b79c5c82c6c2.png",
		...
		Package: packaging.Best(&linux.Flatpak{
			...
			Source: &packaging.Source{
				URL:    "https://archive.org/download/yuzu-emulator-latest-builds-4032024/yuzu-windows-msvc-20240304-537296095.zip",
				Format: "zip",
			},
		}),
	}
